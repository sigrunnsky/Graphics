...
glShadeModel(GL_FLAT);
  ...
  //right
  lights(-4.5,4.5,5);
  lights(-4.5,4.25,4.75);//
  lights(-4.5,4, 4.5);
  lights(-4.5,3.75,4.25);//
  lights(-4.5,3.5,4);
  lights(-4.5,3.25,3.75);//
  lights(-4.5, 3, 3.5);
  lights(-4.5,2.75,3.25);//
  lights(-4.5,2.5,3);
  lights(-4.5,2.25,2.75);//
  lights(-4.5, 2, 2.5);
  lights(-4.5,1.75,2.25);//
  lights(-4.5,1.5,2);
  lights(-4.5,1.27,1.75);
  //left)
  lights(-4.5,4.5,5);
  lights(-4.5,4.25,5.25);//
  lights(-4.5,4, 5.5);
  lights(-4.5,3.75,5.75);//
  lights(-4.5,3.5,6);
  lights(-4.5,3.25,6.25);//
  lights(-4.5, 3, 6.5);
  lights(-4.5,2.75,6.75);//
  lights(-4.5,2.5,7);
  lights(-4.5,2.25,7.25);//
  lights(-4.5, 2, 7.5);
  lights(-4.5,1.75,7.75);
  lights(-4.5,1.5,8);

  //right side
  lights(-5,1.27,1.75);
  lights(-5.5,1.27,1.75);
  lights(-6,1.27,1.75);
  lights(-6.5,1.27,1.75);
  lights(-7,1.27,1.75);
  lights(-7.5,1.27,1.75);
  lights(-8,1.27,1.75);
  lights(-8.5,1.27,1.75);
  lights(-9,1.27,1.75);
  lights(-9.5,1.27,1.75);
  lights(-10,1.27,1.75);
  lights(-10.35,1.27,1.75);
  lights(-10.8,1.27,1.75);
  ...
  // glBegin(GL_LINES);
  // glColor3f(0, 1, 1);
  // glVertex3d(-4.5,1.5,8);
  // glVertex3d(-4.5,4.5,5);
  // glColor3f(0, 1,1);
  // glVertex3d(-4.5,1.5,2);
  // glVertex3d(-4.5,4.5,5);
  // glEnd();
